...
fun case_3() {
    if (_Object.prop_1 != null)
        ...
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Nothing? & kotlin.Number?")!>_Object.prop_1<!>
    }
}
...
fun case_8(x: _TypeAliasNullableString) {
    if (x == null && <!SENSELESS_COMPARISON!><!DEBUG_INFO_CONSTANT, DEBUG_INFO_EXPRESSION_TYPE("_TypeAliasNullableString /* = kotlin.String? */ & kotlin.Nothing?")!>x<!> == null<!>)
...
fun case_11(x: _TypeAliasNullableString<!REDUNDANT_NULLABLE!>?<!>, y: _TypeAliasNullableString) {
    val z: _TypeAliasNullableString = null
...
// TESTCASE NUMBER: 12
fun case_12(x: _TypeAliasNullableString, y: _TypeAliasNullableString) = <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.String?")!>if (x != null && true && true && true) "1"
    else if (y != null) <!DEBUG_INFO_CONSTANT, DEBUG_INFO_EXPRESSION_TYPE("_TypeAliasNullableString /* = kotlin.String? */ & kotlin.Nothing?")!>x<!>
    else "-1"<!>

// TESTCASE NUMBER: 13
fun case_13(x: otherpackage._EmptyClass13_14?) =
    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Nothing?")!>if (x != null && true) {
        throw Exception()
    } else <!DEBUG_INFO_CONSTANT, DEBUG_INFO_EXPRESSION_TYPE("kotlin.Nothing? & otherpackage._EmptyClass13_14?")!>x<!><!>

// TESTCASE NUMBER: 14
class Case14 {
    val x: otherpackage._EmptyClass13_14?
    init {
        x = otherpackage._EmptyClass13_14()
    }
}
                                                ...
                                                if (<!SENSELESS_COMPARISON!>a.x == null<!>) {
                                                    if (<!SENSELESS_COMPARISON!>a.x == null<!>) {
                                                        if (<!SENSELESS_COMPARISON!>a.x == null<!>) {
                                                            if (<!SENSELESS_COMPARISON!>a.x == null<!>) {
                                                                if (<!SENSELESS_COMPARISON!>a.x == null<!>) {
                                                                    <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Nothing? & otherpackage._EmptyClass13_14?")!>a.x<!>
                                                                }
                                                            }
                                                        }
                                                    }
...
// TESTCASE NUMBER: 21
fun case_21() {
    if (_EnumClassWithNullableProperty.B.prop_1 == null) {
        <!DEBUG_INFO_EXPRESSION_TYPE("kotlin.Int? & kotlin.Nothing?")!>_EnumClassWithNullableProperty.B.prop_1<!>
    }
}
