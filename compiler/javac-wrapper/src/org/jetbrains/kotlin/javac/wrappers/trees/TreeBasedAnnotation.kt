...
private fun createAnnotationArguments(
    annotation: TreeBasedAnnotation, javac: JavacWrapper, onElement: JavaElement
        ...
        annotation.annotation.arguments.mapNotNull {
            ...
            val containingClass = annotation.resolve()
            if (containingClass == null) null
            else createAnnotationArgument(it, name, annotation.compilationUnit, javac, containingClass, onElement)
        }
